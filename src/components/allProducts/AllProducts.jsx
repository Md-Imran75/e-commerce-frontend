...
import { price_range_product, query_products , get_products } from '../../store/reducers/homeReducer'
                    ...
                    <div className='w-full flex flex-wrap'>
                       {
                        ...
                        <h2 className='text-2xl font-bold mb-3 text-black-500'>Top Model</h2>
                        <div className='py-2'>
                            {
