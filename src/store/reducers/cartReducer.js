...
export const add_to_cart = createAsyncThunk(
    ...
    async (info, {
        ...
        try {
            const {
                data
            } = await api.post('/home/product/add-to-cart', info)
...
export const get_cart_products = createAsyncThunk(
    ...
    async (userId, {
        ...
        try {
            const {
                data
            } = await api.get(`/home/product/get-cart-product/${userId}`)
...
export const quantity_inc = createAsyncThunk(
    ...
    async (cart_id, {
        ...
        try {
            const {
                data
            } = await api.put(`/home/product/quantity-inc/${cart_id}`)
            return fulfillWithValue(data)
        } catch (error) {
            return rejectWithValue(error.response.data)
        }
...
export const quantity_dec = createAsyncThunk(
    ...
    async (cart_id, {
        ...
        try {
            const {
                data
            } = await api.put(`/home/product/quantity-dec/${cart_id}`)
            return fulfillWithValue(data)
        } catch (error) {
            return rejectWithValue(error.response.data)
        }
    ...
    extraReducers: (builder) => {
        builder
            ...
            .addCase(get_cart_products.fulfilled, (state, { payload }) => {
                ...
                state.booking_fee = payload.booking_fee;
